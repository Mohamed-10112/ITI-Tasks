...
public partial class CompanySdContext : DbContext
{
    ...
    public virtual DbSet<EmployeeView2> EmployeeView2s { get; set; }
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
    {
        ...
        {
            var connString = ConfigurationManager.ConnectionStrings["CompanyDb"].ConnectionString;
    ...
    {
        modelBuilder.Entity<CoursesView>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("CoursesView");
